...
```bash
cat .planning/E*/.continue-here.md 2>/dev/null
```

Parse YAML frontmatter for: epic, feature, story, task, status, last_updated
Parse markdown body for: AC status, completed work, remaining work, context
</step>
...
```bash
rm .planning/EXX-name/.continue-here.md
```
...
2. Discard handoff, reassess from user story
...
1. epics/E02-dashboard/.continue-here.md (3 hours ago)
2. epics/E01-auth/.continue-here.md (2 days ago)
